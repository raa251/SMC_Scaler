double M_SearchNewLow(MqlRates &aCandles[])
{
   ...
   bool bCondition3 = aCandles[nMiddleCandleIndexRight].open < aCandles[nMiddleCandleIndexRight].close;   // Bullish candle
   bool bCondition4 = aCandles[nMiddleCandleIndexLeft].open > aCandles[nMiddleCandleIndexLeft].close;     // Bearish candle
